...
public class Robotv8_AutoBase extends Robotv8_Fullstack {
    ...
    public int alliance = 1; // -1 for blue

    public int detectedSpikeResult = 0;
            ...
            case SEARCHING: // covers getting purple out
                if (detected) {
                    if (handler.localizer.spikeMark == 1) {
                        EncoderMove(0.5, -0.3 * alliance, 0.3 * alliance, false, false, 3);
                        Delay(200);

                        ExpelPixel();

                        EncoderMove(0.5, -0.7 * alliance, 0.7 * alliance, false, false, 3);
                        Delay(200);
                        ...
                        EncoderMove(0.5, 0.3, 0.3, false, false, 3);
                        EncoderMove(0.5, -1 * alliance, 1.0 * alliance, false, false, 3);
                        Delay(200);
                        EncoderMove(0.5, -1, -1, false, false, 3);
                        Delay(200);
                        ...
                        EncoderMove(0.5, -1.3 * alliance, 1.3 * alliance, false, false, 3);
                        Delay(200);
                        EncoderMove(0.5, -1, -1, false, false, 3);
                        Delay(200);
    ...
    public void MainLoop() {
        detectedSpikeResult = handler.localizer.telemetryTfod();
        //handler.localizer.propTfod(false);
        //AutonomousSubsystem();
    }
}
